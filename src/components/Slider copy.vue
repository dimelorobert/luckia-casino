		...
		<ul class="slides">
			<li class="slide" id="slide1">
				<a href="#">
					...
					<img src="../assets/lu5.jpg" alt="photo 1" />
				</a>
			</li>
			<li class="slide" id="slide2">
				<a href="#">
					<p class="caption">Texto llamativo</p>
					<img src="../assets/lu4.jpg" alt="photo 2" />
				</a>
			</li>
			<li class="slide" id="slide3">
				<a href="#">
					<p class="caption">Texto llamativo</p>
					<img src="../assets/lu5.jpg" alt="photo 3" />
				</a>
			</li>
			<li class="slide" id="slide4">
				<a href="#">
					<p class="caption">Texto llamativo</p>
					<img src="../assets/lu4.jpg" alt="photo 4" />
				</a>
			</li>
			<li class="slide" id="slide5">
				<a href="#">
					<p class="caption">Texto llamativo</p>
					<img src="../assets/lu5.jpg" alt="photo 5" />
				</a>
			</li>
		</ul>
